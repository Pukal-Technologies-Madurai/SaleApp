...
const SalesReturnList = () => {
    ...
    const {
        ...
        queryKey: ["salesReturnList", selectedFromDate, selectedFromDate, userId],
        queryFn: () => fetchItemSaleReturn(selectedFromDate, selectedFromDate, userId),
        enabled: !!selectedFromDate && !!userId,
    });
                    ...
                    <View style={styles.productsSection}>
                        <View style={styles.productsSectionHeader}>
                            ...
                            <TouchableOpacity 
                                ...
                                onPress={() => navigation.navigate('SalesReturn', { item, isEditMode: true })}
                                activeOpacity={0.7}
                            >
                                <Icon
                                    name="edit"
    ...
    if (isLoadingReturns) {
        return (
            <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
                <AppHeader title="Sales Return List" navigation={navigation} />
